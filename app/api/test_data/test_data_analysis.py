mock_fact_check_result = {
    "version": "1.0.0",
    "summary": "Article claims '30% of users are affected by data breach' with unverified statistics",
    "likelihood_score": 0.65,
    "confidence": 0.78,
    "rationale": "Article cites a non-peer-reviewed internal report from a company with no public evidence of the breach",
    "key_claims": [
        {"claim": "30% of users were impacted by data breach", "confidence": 0.45},
        {"claim": "Breach occurred in Q3 2023", "confidence": 0.82}
    ],
    "detected_tactics": ["unverified sources", "statistical manipulation", "sponsored content framing"],
